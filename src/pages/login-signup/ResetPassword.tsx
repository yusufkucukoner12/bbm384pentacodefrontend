...
const ResetPassword: React.FC = () => {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    try {
      const response = await axios.post<ResetPasswordResponse>('http://localhost:8080/api/resetpassword', {
        email,
      });
      ...
      setError('Reset failed. Please check your email.');
      setSuccess('');
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-gray-100">
      ...
      <div className="relative z-10 bg-white p-8 rounded-lg shadow-md w-full max-w-md">
        ...
        <p className="text-center mb-6">Enter your email to receive a reset link.</p>
