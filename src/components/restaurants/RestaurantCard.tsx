...
export function RestaurantCard({ restaurant }: Props) {
  ...
  return (
    <div className="w-full sm:max-w-sm md:max-w-md lg:max-w-lg mx-auto bg-orange-50 rounded-2xl shadow-md hover:shadow-xl transition-shadow duration-300 ease-in-out overflow-hidden">
      <Link
      ...
      >
        ...
        <div className="p-6 space-y-4">
          <h3 className="text-2xl font-semibold text-gray-900 truncate leading-tight">{restaurant.name}</h3>
          ...
          <p className="text-gray-700 text-sm leading-relaxed line-clamp-2">{restaurant.description}</p>
      ...
      <div className="px-6 pb-6 pt-2 flex justify-end">
        {isLoading ? (
          ...
          <button
            ...
            className="px-4 py-2 bg-amber-800 text-white rounded-md hover:bg-amber-900 focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 transition-colors duration-200 flex items-center space-x-2"
